...
% observations, residuals follow a normal distribution with an outlier.
% 
...
eD = zeros(6,length(alpha),4,perm_tot);
addpath '..'
...
for i2=1:perm_tot
    ...
    [kk,ind] = sort(randn(size(Xnoise,1)));
    Xnoise(ind(1),:) = 10*Xnoise(ind(1),:);
